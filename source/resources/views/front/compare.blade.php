...
@section('content')
    <div class="container">
        ...
        <div class="row mb-4 counter">
            <div class="col-12 justify-content-between d-md-flex py-4">
                <b class="font-weight-bold font-25 ">African Sun Limited</b>
                <div class="compare-search ">
                    <form action="#">
                        <input type="text" class="search" placeholder="Compare with">
            ...
            <div class="col-lg-12">
                <div class="compare-container">
                    <div class="controls-container float-left">
                        <a href="" class="btn py-2 btn-primary mb-1">All Share</a>
                        <a href="" class="btn py-2 btn-primary mb-1">Top 10</a>
                        <a href="" class="btn py-2 btn-primary mb-1">Industrial</a>
                        <a href="" class="btn py-2 btn-primary mb-1">Mining</a>
                        <a href="" class="btn py-2 btn-danger mb-1">Clear</a>
                    </div>
                    <div class="chart-container float-md-right">
                        <div class="full-width" id="stock-chart-type-three"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script src="https://code.highcharts.com/modules/stock-tools.js"></script> <script>
     Highcharts.getJSON('https://demo-live-data.highcharts.com/aapl-ohlcv.json', function (data) {
        ...
        Highcharts.stockChart('stock-chart-type-three', {
            yAxis: [{
                labels: {
                    align: 'left'
                },
