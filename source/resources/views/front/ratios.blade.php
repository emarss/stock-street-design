    ...
    <div class="container">
        ...
        <div class="row mb-4 counter">
            <div class="col-12 justify-content-between d-md-flex py-1">
                <b class="font-weight-bold font-20">African Sun Limited Ratios</b>
                <div>
                    <a href="" class="btn btn-blue mx-0 py-1-5 active">Profitability</a>
                    <a href="" class="btn btn-blue mx-0 py-1-5">Growth</a>
                    <a href="" class="btn btn-blue mx-0 py-1-5">Financial Health</a>
